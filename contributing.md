...
before making a change. You do not need to wait for an answer, just create an issue and you can
start contributing!

## Pull Request Process

1. Before beginning make sure you base your work off the `develop` branch.
1. Every additional code needs to have a test associated with it. Usually you should
   always try to keep the code coverage at 100%.
...
reported by contacting the project team at dev@findologic.com. All
